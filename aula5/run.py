...
minha_collection_repository.select_many()

minha_collection_repository.select_one()
...
minha_collection_repository.edit_registro()

minha_collection_repository.edit_registros()


filtro = {"_id": ObjectId("66a428fdad31ec48b16a0bbb")}
propriedades = {
    "endereco" : {
        "cep": "03380520",
        "rua": "das ruas",
...
# minha_collection_repository.edit_coluna(filtro, propriedades)


# ************************* EXCLUSÃO DE DADOS *********************************
minha_collection_repository.delete_registros()

minha_collection_repository.delete_registro()
